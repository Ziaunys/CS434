...
\end{figure}
		...
		\\
		\\
		When we start at looking at the leafs of the full tree we see that they both have the same information gain however when we go up the tree to those node's parent we see that there is no information gain.  
		\end{enumerate} 	
