...
\begin{enumerate} 
	...
	\begin{enumerate} 
		...
		$H(S_{1}) = -\frac{1}{2}log_{2}\frac{1}{2} - \frac{1}{2}log_{2}\frac{1}{2} = 1.0$ \\
		$H(S_{2}) = -\frac{2}{3}log_{2}\frac{2}{3} - \frac{1}{3}log_{2}\frac{1}{3} = .91$ \\
		...
		For X: \\
		$H(S) = -\frac{2}{5}log_{2}\frac{2}{5} - \frac{3}{5}log_{2}\frac{3}{5} = .97$ \\
		$H(S_{1}) = -\frac{0}{2}log_{2}\frac{0}{2} - \frac{2}{2}log_{2}\frac{2}{2} = 0$ \\
		$H(S_{2}) = -\frac{1}{3}log_{2}\frac{1}{3} - \frac{2}{3}log_{2}\frac{2}{3} = .91$ \\
